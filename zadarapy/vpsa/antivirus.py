...
def get_policies(session, return_type=None, **kwargs):
    ...
    path = '/api/antivirus/default_policy'
...
def update_on_demand_policy(session, run_policy, include_file_types=None, exclude_file_types=None,
    ...
    path = '/api/antivirus/update_ods_defaults'
...
def download_raw_log_file(session, volume_id, return_type='raw', **kwargs):
    """
    ...
    return session.get_api(path=path, return_type=return_type, secure=False, **kwargs)
