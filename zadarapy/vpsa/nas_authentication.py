...
def join_active_directory(session, display_name, username, password,
    ...
    :param uid_range_low: Low range ID.  Optional (will return a Python dictionary by default).

    :type uid_range_high: int
    :param uid_range_high: High range ID.  Optional (will return a Python dictionary by default).
