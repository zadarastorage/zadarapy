...
KMIP_ENCRYPTION_OPTIONS = [
    ...
    },
    {
        ...
        'option_keywords': {
            ...
            'default': '1.2',
            'help': 'The KMIP version: 1.0, 1.1, 1.2, 1.3, 1.4, 2.0 '
        }
    },
    {
        ...
        'option_keywords': {
            ...
            'type': str,
            'default': None,
            'help': 'The user name credential in order to authenticate with the KMIP server. '
    ...
    },
    {
        ...
        'option_keywords': {
            ...
            'type': str,
            'default': None,
            'help': 'The password credential in order to authenticate with the KMIP server (corresponding to user name). '
                    'This serves as one of the ways to authenticate with the KMIP server.'
        }
    },
    {
        ...
        'option_keywords': {
            ...
            'type': str,
            'default': None,
            'help': 'Current master encryption password. Required if '
